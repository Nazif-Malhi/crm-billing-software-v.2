...
const AdjustmentForm = () => {
  return (<>
  <Card>
  <Card.Header as="h5">Add Adjustment</Card.Header>
  <Card.Body>
    <Card.Text>
        <p><i style={{color:'red'}}>The field labels marked with * are required input fields.</i></p>
        <Container>
            <Row>
            ...
            <h6>Select Product</h6>
                <Col>
                <TextField type='text' id="outlined-basic" label="Type product code & select" variant="outlined" size="small" style={{width:'100%'}}/>
                </Col>
            </Row>
            <Row>
                <h5>Order Table *</h5>
